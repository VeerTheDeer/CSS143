...
public class Rectangle /* extends Shape */ {
	 ...
	 * these are the 4 instance variables that are in the class Rectangle (4/4)
	 */
	...
	/*
	 * 2. Variable Scope in Java: Local and Class-Level
	 * parameters are considered and treated as local variables, here are 2 however
	 *  further on there is another local variable that i found before this so this is (1/2)
	 */
	...
	public static boolean isEquals(Rectangle one, Rectangle two) {
		...
		/*
		 * 2. Variable Scope in Java: Local and Class-Level
		 * the boolean variable above is a local variable (2/2)
		 */
